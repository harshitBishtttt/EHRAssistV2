        ...
        <div className="login-left">
          <div className="login-content">
            <h1 className="login-heading">
              Instant <span className="teal">Patient Insights</span>
              <br />
              for Care Teams
            </h1>
            <p className="login-desc">
              Give care coordination team instant, secure access to a complete patient view, labs, medications,
              patient history, and care gaps, <b>Powered by AI</b> and <b>fully integrated with your existing EHR</b>, to
              act faster, reduce risk, and keep patients on track.
            </p>
