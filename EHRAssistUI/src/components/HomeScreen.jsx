...
export function HomeScreen() {
  ...
  return (
    <div id="home-screen">
      ...
      <main className="home-main">
        <section className="hero">
          ...
          <p className="hero-sub">
            Access patient records, lab results, medications, and clinical history instantly — powered by AI and FHIR
            R4 integration.
          </p>
        </section>
      ...
      <button type="button" className="logout-btn-fixed" onClick={logout} aria-label="Log out">
        <LogoutIcon />
        Log Out
      </button>
    </div>
